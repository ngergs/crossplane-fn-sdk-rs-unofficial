...
/// Helper for the default and `k8s-openapi`-specific implementations of `TryFromResource`.
/// Will serialize the resource to a [`serde_json::Value`], apply the [`json_value_cast_float_to_i64`]
/// and subsequently call [`from_value_strict`].
fn try_from_resource<T: DeserializeOwned, const N: usize>(
    value: Resource,
    ...
    from_value_strict(value, allowed_ignored_fields)
}
